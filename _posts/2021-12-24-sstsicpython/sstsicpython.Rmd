...
**#Use a for loop to open all data files as datasets**\
...
Ensure that the type of the time cariable is datetime64.
...
This code importing process is similar to my code for importing the sea surface temperature data. One of my collaborators on this project, [Peter Menzies](https://petermenzies.github.io/), wrote the code to import the sea ice data.
