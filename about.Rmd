...
![A hike in the Ko'olau Mountains in Oahu, Hawaii (2019)](about_pics/hike_smile.jpg){width="63%"}![](about_pics/desert_snake.jpg){width="37%"}
...
![](about_pics/bivalve_erin.JPG){width="50%"}![](about_pics/turbidity_measurement.JPG){width="50%"}

###### Left: Measuring the water displacement of individual bivalves at the end of a field day with my colleague Erin, who was relaxing on the boat after a day of snorkeling and data collection for her own research.

###### Right: Measuring the turbidity of my various species-specific buckets at regular time intervals. I would dive into the mariculture nets each day to collect new bivalve species, run my secchi disk filtration trials with algae and bryozoans in the buckets, then return the bivalves to their natural habitat at the end of the day.
...
![Deep in a humid, mosquito-filled gulch, I spotted a juvenile *Miconia calvescens* plant and plucked it with enthusiasm.](about_pics/miconia.JPG){width="65%"}
...
![Taking a break from tedious plants surveys to admire the the views of the west side of the island. In the upper elevations of the Wai'anae Mountains, we surveyed for the incipient invasive plant species Chromolaeana odorata](about_pics/fence.jpg){width="65%"}

</center>

![](about_pics/KKC_heli.jpg){width="50%"}![](about_pics/first_heli.jpg){width="50%"}
...
![A redd survey in Gobernador Creek in Carpinteria](about_pics/KC_survey.jpg){wifth=65%}

![A redd survey in Matilija Creek in Ojai](about_pics/HA_survey.jpg){width=65%}
...
![Measuring a small trout we caught while electric fishing before returning it to the creek.](about_pics/measure_fish.JPG){width=50%}

![We often found two-striped garter snakes on survey in riparian habiat. This snake species is not aggressive towards predators such as humans, but rather predates on fish (like chub and trout), insects, and other smaller prey.](about_pics/snake_arm.JPG){width=65%}
