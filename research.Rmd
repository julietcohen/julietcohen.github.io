...
```{r image-ref-for-in-text, echo = FALSE, message=FALSE, fig.align='center', fig.cap='My Undergraduate thesis', out.width='0.75\\linewidth', fig.pos='H'}
knitr::include_graphics("./research/URCA_Poster_PDF.pdf")

```

![](research/URCA_Poster_PDF.pdf)
